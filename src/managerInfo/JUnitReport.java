...
/// (FearlessLang/EclipsePlugin), which polls that file into the JUnit view; `suite`
/// and `document` also build the report the Coordinator's own integration run publishes.
